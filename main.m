...
DR_3x3_SSD = disparity_map(L,R,1,1);
DR_5x5_SSD = disparity_map(L,R,2,1);
DR_7x7_SSD = disparity_map(L,R,3,1);
DR_9x9_SSD = disparity_map(L,R,4,1);
DR_3x3_NCC = disparity_map(L,R,1,2);
DR_5x5_NCC = disparity_map(L,R,2,2);
DR_7x7_NCC = disparity_map(L,R,3,2);
DR_9x9_NCC = disparity_map(L,R,4,2);
